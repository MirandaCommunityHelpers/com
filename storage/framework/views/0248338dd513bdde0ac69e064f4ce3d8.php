            ...
            <div class="card card-outline card-primary">
                <dv class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(url('admin/pagos/create')); ?>" class="btn btn-primary">
                            Registrar nuevo
                        </a>
                    </div>
                </dv>
                <div class="card-body">
                    <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                        ...
                        <?php $__currentLoopData = $pagos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pago): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($pago->paciente->apellidos." ".$pago->paciente->nombres); ?></td>
                                <td><?php echo e($pago->doctor->apellidos." ".$pago->doctor->nombres); ?></td>
                                <td style="text-align: center"><?php echo e($pago->fecha_pago); ?></td>
                                <td><?php echo e($pago->monto); ?></td>
                                <td><?php echo e($pago->descripcion); ?></td>
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="<?php echo e(url('admin/pagos/'.$pago->id)); ?>" type="button" class="btn btn-info btn-sm"><i class="bi bi-eye"></i></a>
                                        <a href="<?php echo e(url('admin/pagos/pdf/'.$pago->id)); ?>" type="button" class="btn btn-warning btn-sm"><i class="bi bi-printer"></i></a>
                                        <a href="<?php echo e(url('admin/pagos/'.$pago->id.'/edit')); ?>" type="button" class="btn btn-success btn-sm"><i class="bi bi-pencil"></i></a>
                                        <a href="<?php echo e(url('admin/pagos/'.$pago->id.'/confirm-delete')); ?>" type="button" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <hr>
                    <p><h4>Resumen total del monto de pagos: <?php echo e($total_monto); ?></h4></p>
                    <script>
                        $(function () {
                            $("#example1").DataTable({
                                "pageLength": 5,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mch\resources\views/admin/pagos/index.blade.php ENDPATH**/ ?>