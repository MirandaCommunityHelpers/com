    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <form action="<?php echo e(url('/admin/usuarios/create')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mch\resources\views/admin/usuarios/create.blade.php ENDPATH**/ ?>