...
<!--
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.horarios.index')): ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.configuraciones.index')): ?>
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-primary">
                        <div class="inner">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mch\resources\views/admin/index.blade.php ENDPATH**/ ?>