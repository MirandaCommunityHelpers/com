...
<header id="header" class="header sticky-top">
    ...
    <div class="branding d-flex align-items-center">
        ...
        <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <a class="cta-btn d-none d-sm-block" href="<?php echo e(url('login')); ?>">Ingresar</a>
                ...
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="why-box" data-aos="zoom-out" data-aos-delay="200">
                        ...
                        <div class="text-center">
                            <a href="<?php echo e(url('/admin')); ?>" class="more-btn"><span>Reservar ahora</span> <i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                </div><!-- End Why Box -->
...
<?php /**PATH C:\xampp\htdocs\sisreservasdecitasmedicas\resources\views/index.blade.php ENDPATH**/ ?>