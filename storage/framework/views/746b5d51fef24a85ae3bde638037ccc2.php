...
<head>
    ...
    <script src="<?php echo e(url('fullcalendar/es.global.js')); ?>"></script>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?php echo e(url('/admin')); ?>" class="nav-link">Sistema de reserva de citas medicas</a>
            </li>
        </ul>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.usuarios.index')): ?>
                        <li class="nav-item">
                            <a href="<?php echo e(url('/admin/configuraciones')); ?>" class="nav-link active">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.secretarias.index')): ?>
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/secretarias/create')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Creación de secretarias</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/secretarias')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.consultorios.index')): ?>
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/consultorios/create')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Creación de consultorios</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/consultorios')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.doctores.index')): ?>
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/doctores/create')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Creación de doctores</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/doctores')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Listado de doctores</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/doctores/reportes')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Reportes</p>
                                    </a>
                                </li>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.horarios.index')): ?>
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/horarios/create')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Creación de horarios</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/horarios')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.usuarios.index')): ?>
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/reservas/reportes')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Reportes</p>
                                    </a>
                                </li>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.historial.index')): ?>
                        <li class="nav-item">
                            <a href="#" class="nav-link active">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/historial')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Listado del historial</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/historial/buscar_paciente')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Buscar paciente</p>
                                    </a>
                                </li>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.pagos.index')): ?>
                        <li class="nav-item">
                            <a href="#" class="nav-link active">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/pagos')); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('logout')); ?>" class="nav-link" style="background-color: #a9200e" id=""
...
<?php /**PATH C:\xampp\htdocs\sisreservasdecitasmedicas\resources\views/layouts/admin.blade.php ENDPATH**/ ?>